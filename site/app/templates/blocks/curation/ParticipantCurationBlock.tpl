<div>
	<div class='col-lg-3 col-md-3 col-sm-4 col-xs-4'>
		<textarea class="form-control" placeholder='Enter identifiers, one per line' name='{{BASE_NAME}}-participants' id='{{BASE_NAME}}-participants' rows="10"></textarea>
	</div>
	<div class='col-lg-3 col-md-3 col-sm-5 col-xs-5'>
		<div class='clearfix'>
		<div class='form-group'>
			<label class='col-sm-4 control-label marginTopSm'>Role:</label>
			<div class='col-sm-8 marginBotSm'>
		...
		<div class='form-group'>
			<label class='col-sm-4 control-label marginTopSm'>Taxa:</label>
			<div class='col-sm-8 marginBotSm'>
		...
		<div class='form-group'>
			<label class='col-sm-4 control-label marginTopSm'>IDs:</label>
			<div class='col-sm-8 marginBotSm'>
		...
		<div class='form-group'>
			<label class='col-sm-4 control-label marginTopSm'>Type:</label>
			<div class='col-sm-8 marginBotSm'>
