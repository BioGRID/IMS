<li>
	...
	<ul class='curationSubmenu'>
		...
		{% endfor %}
		{% if IS_PARTICIPANT %}
			<li class='subattributeLink'><i class='fa fa-angle-double-right'></i> <a class='addSubAttribute' id='workflowSubLink-{{ ID }}' data-parenttitle='{{ TITLE }}' data-parentblockid='{{ ID }}'>Add Sub-Attribute <i class='fa fa-plus-square-o'></i></a></li>
		{% endif %}
	</ul>
